...
public class ConfigManager {
    ...
    private static final String MAPS_CONFIG = "plugins/Shrooms/maps.json";
    private static final String GENERAL_CONFIG = "plugins/Shrooms/config.json";
    ...
    public static void initConfigs() {
        try {
            Files.createDirectories(new File("plugins/Shrooms").toPath());
